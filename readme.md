...
### Features
* The algorithm C code is generated from a graphical [Scilab](https://www.scilab.org) model with [X2C](https://x2c.lcm.at/downloads/) tool 
* The low level MCU peripheral configuratein is generated by [MCC](https://www.microchip.com/mplab/mplab-code-configurator)
* The manual C project and the development is done by [MPLAB X](https://www.microchip.com/mplab/mplab-x-ide)
* [Simulation](#simulation) on PC Scilab
* Run time [monitoring](#monitoring-signals) (virtual scope)
* Changing control parameters in runtime
