...
#define INIT                (*pTSin2Limiter_Float64->Init)
#define ENABLE              (*pTSin2Limiter_Float64->Enable)
...
#define ENABLE_OLD          (pTSin2Limiter_Float64->Enable_old)
